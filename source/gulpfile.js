...
gulp.task('server', function (callback) {
    runSequence('sass-reload', 'styles', 'move', 'js-dist', callback);
    browserSync.init({
        server: {
            baseDir: "./dist/"
        }
...
gulp.task('sass-reload', function (callback) {
    runSequence('compile-sass', 'reload', callback);
});
...
gulp.task('dist', function (callback) {
    runSequence('clean-dist', 'sass-reload', 'jade', 'min-img', 'styles', 'js-dist', callback);
